package com.xiangyi.alertdialog;
...
public class MainActivity extends Activity {
    ...
    public void dialog7(){
        ...
        View layou=inflater.inflate(R.layout.diydialog,null);
        final EditText tEdit= (EditText) layou.findViewById(R.id.editText1);
        dialog=new AlertDialog.Builder(this).create();
        dialog.setTitle("自定义布局");
        dialog.setView(layou);
        DialogInterface.OnClickListener listenter=new DialogInterface.OnClickListener(){
            @Override
            public void onClick(DialogInterface dialog, int which) {
                tView.setText("输入的是：");
